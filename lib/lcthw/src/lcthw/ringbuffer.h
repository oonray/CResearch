...
int RingBuffer_empty(RingBuffer *buffer,char *target,int amount);

int RingBuffer_full(RingBuffer *buffer);

int RingBuffer_avaliable_data(RingBuffer *buffer);

int RingBuffer_avaliable_space(RingBuffer *buffer);
